...
import { useAddChickenMutation } from '../../services/products';
...
const AdminCreateMeatJerks = () => {
  ...
  const [addChicken] = useAddChickenMutation()
  ...
  const handleAddChickenJerk = async () => {
    if (!selectedImage) {
    ...
    try {
      const response = await addChicken(formData).unwrap(); 
            ...
            <div className={styles.addProductJerks}>
              ...
              <div className={styles.addProduct__rightContentJerks}>
                ...
                <div className={`${styles.buttons} flex`}>
                  ...
                  <button onClick={handleAddChickenJerk} className={`${styles.btn} btn`}>
                    Create
                  </button>
                </div>
              </div>
