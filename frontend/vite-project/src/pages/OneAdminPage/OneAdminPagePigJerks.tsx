                            ...
                            <div className={styles.containerProductItem}>
                                ...
                                <div className={styles.productInfo}>
                                    <div className={styles.leftContent}>
                                        <img
                                            src={`https://eccom-maaakara-backend.onrender.com/${Pigjerks.image}`}
                                            alt={Pigjerks.title}
                                            className={styles.productImg}
                                        />
                                    </div>
                                    <div className={styles.rightContent}>
                                        <p className={styles.priceProduct}>Price: {Pigjerks.price}₴</p>
                                ...
                                <div className={styles.description}>
                                    ...
                                    <p className={styles.productInformation}><strong>Category:</strong> Pig Jerks</p>
                                    <p><strong>Stock Quantity:</strong> {Pigjerks.quantity} Gram</p>
                                    {isAuthenticated && (
