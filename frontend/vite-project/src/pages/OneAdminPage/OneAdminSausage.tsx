                            ...
                            <div className={styles.containerProductItem}>
                                ...
                                <div className={styles.productInfo}>
                                    ...
                                    <div className={styles.rightContent}>
                                        <p className={styles.priceProduct}>Price: {sausage.price}₴</p>
                                ...
                                <div className={styles.description}>
                                    ...
                                    <p className={styles.productInformation}><strong>Category:</strong> Sausage</p>
                                    <p><strong>Stock Quantity:</strong> {sausage.quantity} Gram</p>
                                    {isAuthenticated && (
