...
import { useGetOneChickenQuery,  useRemoveMeatJerkMutation } from "../../services/products";
...
const OneAdminPageMeatjerks: FC = () => {
    ...
    const { data: chicken, error, isLoading } = useGetOneChickenQuery(id!); 
    const [value, setValue] = useState<string>('1');
    const [selectedSize, setSelectedSize] = useState<number | null>(null);
    const [removeChicken] = useRemoveMeatJerkMutation();
    const isAuthenticated = useSelector(selectIsAuthenticated);

    const handleRemove = async () => {
        try {
            await removeChicken(id!).unwrap();
                    ...
                    <>
                        <div className={styles.productOneItem}>
                            <div className={styles.containerProductItem}>
                                ...
                                <h1 className={styles.oneItemLeft}>{chicken.title}</h1>
                                <div className={styles.productInfo}>
                                    ...
                                    <div className={styles.rightContent}>
                                        <p className={styles.priceProduct}>Price: {chicken.price}₴</p>
                                ...
                                <div className={styles.description}>
                                    ...
                                    <p><strong>Stock Quantity:</strong> {chicken.quantity} Gram</p>
                                    {isAuthenticated && (
